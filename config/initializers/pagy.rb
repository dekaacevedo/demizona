...
# Pagy::VARS[:i18n_key]   = 'pagy.item_name'                # default
  #Al clickear Next en la última página, vuelve a la primera
...
# Nos permite evitar la inserción de datos en la url
# Ej: cuando se busca un N° de páginas superior al existente
